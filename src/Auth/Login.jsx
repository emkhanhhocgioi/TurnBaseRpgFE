          ...
          <div style={styles.rightSide}>
            <div style={styles.formContainer}>
              <div style={styles.formHeader}>
                <p style={styles.formBrand}>RavenQuest</p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={styles.divider}>
                  <span style={styles.dividerText}>Trouble signing in?</span>
                </div>
                ...
                <button
                  type="button"
                  style={{...styles.secondaryButton, marginTop: '12px', marginBottom: '24px'}}
                >
                  I DID NOT RECEIVE AN EMAIL TO VALIDATE MY ACCOUNT
                </button>
